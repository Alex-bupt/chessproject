...
void ChessBoard::mouseMoveEvent(QMouseEvent *ev) {
    moveX = (ev->mouse_click_pos_x() - 25) / 90;
    moveY = (940 - ev->mouse_click_pos_y() - 25) / 90;
    moveX1 = (ev->mouse_click_pos_x() - 25) / 90;
    moveY1 = (ev->mouse_click_pos_y() - 25) / 90;
    // qDebug() << ev->mouse_click_pos_x() <<ev->mouse_click_pos_y();
...
void ChessBoard::paintEvent(QPaintEvent *event) {
    ...
    painter->setPen(pen);
    pen.setWidth(1);
    if ((moveX1 * 90 + 70 >= 25) && (moveX1 * 90 + 70) <= 825 && (moveY1 * 90 + 70 >= 25) &&
        (moveY1 * 90 + 70) <= 915) {
...
void ChessBoard::mousePressEvent(QMouseEvent *eve) {
    ChessBoard::mouse_click_pos_x = moveX;
    ChessBoard::mouse_click_pos_y = moveY;
}
